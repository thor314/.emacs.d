...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c m") 'counsel-linux-app) ; launch an application
  (global-set-key (kbd "C-c w") 'counsel-wmctrl) ; switch windows
  (global-set-key (kbd "C-c C-L") 'counsel-locate) ; competes with org store link

  (global-set-key (kbd "C-c C-s C-p") 'counsel-spotify-play)
  (global-set-key (kbd "C-c C-s C-u") 'counsel-spotify-toggle-play-pause)
  (global-set-key (kbd "C-c C-s C-b") 'counsel-spotify-previous)
  (global-set-key (kbd "C-c C-s C-f") 'counsel-spotify-next)
  (global-set-key (kbd "C-c C-s C-s C-s") 'counsel-spotify-search)
  (global-set-key (kbd "C-c C-s C-s C-a") 'counsel-spotify-search-artist)
  (global-set-key (kbd "C-c C-s C-s C-l") 'counsel-spotify-search-album)
  (global-set-key (kbd "C-c C-s C-s C-r") 'counsel-spotify-search-tracks-by-artist)
  (global-set-key (kbd "C-c C-s C-s C-b") 'counsel-spotify-search-tracks-by-album)
