...
(custom-set-variables
 ...
 ;; If there is more than one, they won't work right.
  ...
  '(package-selected-packages
     '(bug-hunter bug-hunter-init helpful command-log-mode bitlbee fira-code-mode ligature esh-autosuggest circe-notifications powerthesaurus restart-emacs circe sx all-the-icons-gnus beacon counsel-spotify moody smartparens-config smartparens request company-anaconda anaconda-mode lsp-ui parrot parrot-mode undo-tree company-prescient ivy-prescient prescient org-ref ivy-bibtex zweilight-theme company-org-roam twittering-mode org-roam poly-markdown poly-org polymode racer paredit rainbow-delimiters org-journal org-mobile languagetool popup popwin yasnippet-snippets yas-snippet-snippets yasnippet lsp-ivy rustic rustic-mode rust-mode lsp-mode flycheck ivy-rich free-keys hydra zoom use-package solarized-theme minions diff-hl counsel-projectile avy auto-compile))
  '(rustic-ansi-faces
