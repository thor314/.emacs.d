...
(define-abbrev-table 'rustic-cargo-fmt-mode-abbrev-table '())

(define-abbrev-table 'rustic-cargo-outdated-mode-abbrev-table '())

(define-abbrev-table 'rustic-cargo-run-mode-abbrev-table '())

(define-abbrev-table 'rustic-cargo-test-mode-abbrev-table '())

(define-abbrev-table 'rustic-compilation-mode-abbrev-table '())

(define-abbrev-table 'rustic-format-mode-abbrev-table '())

(define-abbrev-table 'rustic-macro-expansion-mode-abbrev-table '())

(define-abbrev-table 'rustic-mode-abbrev-table '())

(define-abbrev-table 'rustic-popup-help-mode-abbrev-table '())

(define-abbrev-table 'rustic-popup-mode-abbrev-table '())

(define-abbrev-table 'rustic-racer-help-mode-abbrev-table '())

(define-abbrev-table 'rustic-rustfix-mode-abbrev-table '())
